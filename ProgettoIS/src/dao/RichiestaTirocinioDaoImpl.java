...
public class RichiestaTirocinioDaoImpl implements RichiestaTirocinioDaoInterface {
  ...
  public boolean invioRichiestaTirocinio(RichiestaTirocinio richiestaTirocinio) {
    ...
    try {
      ...
      String query ="INSERT INTO " + "richiestatirocinio "
           + " (nomeTutorAccademico, status, dataInvio, emailTA, emailDI, matricola, idTirocinio,nomeFile)"
           + " VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
  ...
  /**
   * Il metodo effettua una query nel database 
   * per cercare tutte le richieste di tirocinio da parte degli studenti.
  ...
  /**
   * Questo metodo controlla se è presente nel database
   *  una richiesta con la matricola dello studente.
