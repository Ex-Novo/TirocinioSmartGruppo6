...
/**
 * Servlet che consente di visualizzare la lista dei tirocinanti
 * presso una determinata azienda.
 */
...
public class TirocinantiViewControl extends HttpServlet {
  ...
  /**
   * Chiama un metodo dallo studente dao
   * per ritornare una lista di tirocinanti presso l'azienda loggata, 
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    //la p.iva precedentemente presa è usata come parametro della query
    ArrayList<Studente> studenti = studenteDAO.getTirocinanti(piva);
    request.setAttribute("studenti", studenti);
    
    /* Crea lista */
    getServletConfig().getServletContext()
      .getRequestDispatcher("/ListaTirocinanti.jsp").forward(request, response);
