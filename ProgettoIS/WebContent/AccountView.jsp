							...
							<div class="randompad">
								<fieldset>
									<form action="LoginControl"
										...
										<br> <label name="email">Email</label> <input
											type="email" name="email" /> <label name="password">Password</label>
										<input type="password" name="password" /> <input
											type="submit" value="Login" /><br> <a href="">Hai
								...
								<fieldset>
									...
									<form action="RegistrazioneControl"
										...
										<input type="hidden" name="tipo" value="Studente" /> <input
											...
											placeholder="Conferma Password" /> <input
											type="codicefiscale" name="codiceFiscale"
											placeholder="Codice Fiscale" /> <input type="matricola"
											name="matricola" placeholder="Matricola" /> <input
											type="date" name="dataNascita" /> <input type="luogoNascita"
											name="luogoNascita" placeholder="Luogo di Nascita" /> <input
									...
									<form action="RegistrazioneControl"
										...
										<input type="hidden" name="tipo" value="Azienda" /> <input
											type="azienda" name="nomeAzienda" placeholder="Nome Azienda" />
										<input type="sede" name="sede" placeholder="Sede" /> <input
											type="email" name="email" placeholder="Email" /> <input
											type="piva" name="partitaIva" placeholder="Partita Iva" /> <input
											type="telefono" name="telefono"
											placeholder="Numero di telefono" /> <input type="password"
											name="password" placeholder="Password" /> <input
											type="password" name="confermaPsw"
											placeholder="Conferma Password" /> <input type="submit"
											value="Registrati" />
									</form>
									<br> <br>
									<form action="">
